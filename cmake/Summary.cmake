...
function(caffe2_print_configuration_summary)
  ...
  if(${USE_BLAS})
    message(STATUS "    BLAS                : ${BLA_VERDOR}")
  endif()
  ...
  message(STATUS "  USE_MEMORY_SANITIZERS         : ${USE_MEMORY_SANITIZERS}")
  message(STATUS "  USE_MSAN              : ${USE_MSAN}")
  ...
  if(${USE_CUDA})
    ...
    message(STATUS "    CUDA root directory : ${CUDAToolkit_TARGET_DIR}")
    ...
    get_target_property(__tmp caffe2::curand INTERFACE_LINK_LIBRARIES)
    ...
    get_target_property(__tmp caffe2::nvrtc INTERFACE_LINK_LIBRARIES)
