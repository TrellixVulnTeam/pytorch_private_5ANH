...
if(USE_CUDA)
  ...
  if(CAFFE2_USE_CUDA)
    ...
    set(Caffe2_PUBLIC_CUDA_DEPENDENCY_LIBS
      caffe2::cufft caffe2::curand caffe2::cublas torch::nvtoolsext)
    if(CAFFE2_USE_NVRTC)
...
if(TARGET Eigen3::Eigen)
  list(APPEND Caffe2_PRIVATE_DEPENDENCY_LIBS Eigen3::Eigen)
else()
...
set(BLAS_FOUND 1)
list(APPEND Caffe2_PRIVATE_DEPENDENCY_LIBS BLAS::BLAS)
...
if(NOT INTERN_BUILD_MOBILE)
  ...
  if(LAPACK_FOUND)
    set(USE_LAPACK 1)
    list(APPEND Caffe2_PRIVATE_DEPENDENCY_LIBS LAPACK::LAPACK)
  endif()
